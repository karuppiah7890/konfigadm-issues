...
3. We need to add a ntp config file. so that should be there in the file system
4. We need to run some commands to start/restart ntp service. so that should be there in the commands
...
2. Support Fedora
3. add systemd config file if it's not present
